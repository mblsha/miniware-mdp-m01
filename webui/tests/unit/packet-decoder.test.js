...
describe('Packet Decoder', () => {
  ...
  describe('Edge Cases', () => {
    ...
    it('should reject wave packet with bad checksum (capture sample)', () => {
      const hex = [
        '5a', '5a', '12', 'ce', '00', '50', '65', '00', '00', '00', 'ad', '2f', '24', '05',
        'ad', '2f', '01', '05', 'ad', '2f', '3d', '05', 'b5', '2f', '24', '05', 'c4', '01',
        '00', '00', 'ad', '2f', '26', '05', 'ad', '2f', '1c', '05', 'ad', '2f', '33', '05',
        'ad', '2f', '18', '05', '65', '00', '00', '00', 'ad', '2f', '1a', '05', 'ad', '2f',
        '15', '05', 'ad', '2f', '2b', '05', 'ad', '2f', '00', '00', '00', '00', '04', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '05', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '5a', '5a', '11', '9c', '00', 'a6', '00', 'ad',
        '2f', '15', '05', '9a', '4f', '34', '04', 'a8', '2f', '10', '27', '68', '01', '01',
        '02', '01', '02', '01', '80', '99', 'ee', '00', 'ff', '01', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
        ...
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '05', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '5a', '5a', '11', '9c', '00', 'a6', '00',
        'ad', '2f', '15', '05', '9a', '4f', '34', '04', 'a8', '2f', '10', '27', '68', '01',
        '01', '02', '01', '02', '01', '80', '99', 'ee', '00', 'ff', '01', '00', '00', '00',
        '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00', '00',
      ...
      const rawPacket = new Uint8Array(hex.map((byte) => Number.parseInt(byte, 16)));
      const decoded = decodePacket(rawPacket);
      expect(decoded).toBeNull();
    });
