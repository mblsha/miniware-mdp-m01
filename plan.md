...
- Step 4: ✅ controller layer introduced, CLI now calls into it for machine/status/output actions, and controller unit tests exist.
...
- ✅ Harden tests: unit-test the core parser/transport state machine with mocked chunks, then integration-test the CLI/transport wiring without needing real hardware (controller tests cover basic sequencing).
