...
- Step 4: ✅ roadmap items captured below.

## Future roadmap
- Extract `packages/mdp-core/` containing protocol utilities (packet encoder/decoder, Kaitai runtime shim, machine utils) with environment-neutral exports.
